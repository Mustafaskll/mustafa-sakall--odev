...
<br>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input required maxlength="15" type="text" name="kullanici_adi" placeholder="Kullanıcı Adı"> <br>
<br>
      
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input required maxlength="15"  type="password" name="sifre" placeholder="Şifre"> <br>
